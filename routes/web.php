...
Route::middleware('admin')->group(function () {
    ...
    Route::delete('/admin/categories/{id}/delete', 'App\Http\Controllers\Admin\AdminCategoryController@destroy')->name("admin.category.delete");
    ...
    Route::delete('/admin/goals/{id}/delete', 'App\Http\Controllers\Admin\AdminGoalController@destroy')->name("admin.goal.delete");
